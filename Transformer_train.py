...
# Save model
torch.save(decoder.state_dict(), transformer_weights_path)
print(f"Model saved at {transformer_weights_path}")

# Load chỉ trọng số để predict
# decoder.load_state_dict(torch.load(transformer_weights_path))
# decoder.eval()